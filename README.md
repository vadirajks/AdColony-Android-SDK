...
* Modified: September 21st, 2026
* SDK Version: 4.8.2-jenkins-1789991636822
...
dependencies {
   ...
   */
  implementation 'com.adcolony:sdk:4.8.2-jenkins-1789991636822'
}
```
