...
* Modified: September 22nd, 2026
* SDK Version: 4.8.3-jenkins-1790060814655
...
dependencies {
   ...
   */
  implementation 'com.adcolony:sdk:4.8.3-jenkins-1790060814655'
}
```
